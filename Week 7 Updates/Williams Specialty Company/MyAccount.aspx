...
<body>
    ...
    <div>
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT * FROM [Customer] WHERE [CustID] = ?" DeleteCommand="DELETE FROM Customer WHERE (CustID = ?)" InsertCommand="INSERT INTO [Customer] ([CFName],[CLName], [CCNum], [CCExp], [CCPin], [CCType]) VALUES (?, ?, ?, ?,?,?)" UpdateCommand="UPDATE [Customer] SET [CFName] = ?, [CLName] = ?, [CCNum] = ?, [CCExp] = ?, [CCPin] = ?, [CCType] = ? WHERE [CustID] = ?" OnSelecting="SqlDataSource1_Selecting">
            <DeleteParameters>
    ...
    &nbsp;&nbsp;&nbsp;
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" DeleteCommand="DELETE FROM [Address] WHERE [AddressID] = ?" InsertCommand="INSERT INTO [Address] ([AddressID], [AddressLine1], [AddressLine2], [City], [StateCode], [PostalCode]) VALUES (?, ?, ?, ?, ?, ?)" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT * FROM [Address] WHERE [AddressID] = ?" UpdateCommand="UPDATE [Address] SET [AddressLine1] = ?, [AddressLine2] = ?, [City] = ?, [StateCode] = ?, [PostalCode] = ? WHERE [AddressID] = ?">
            <DeleteParameters>
                <asp:Parameter Name="AddressID" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" DeleteCommand="DELETE FROM [PurchaseOrderDetail] WHERE [OrderID] = ? AND [OrderDetailID] = ?" InsertCommand="INSERT INTO [PurchaseOrderDetail] ([OrderID], [OrderDetailID], [OrderQty], [ProdID], [Message], [ProdTotal]) VALUES (?, ?, ?, ?, ?, ?)" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT OrderID, OrderDetailID, OrderQty, ProdID, Message, ProdTotal, CustID FROM PurchaseOrderDetail WHERE (CustID = ?)" UpdateCommand="UPDATE PurchaseOrderDetail SET Message = ? WHERE (OrderID = ?) AND (OrderDetailID = ?)">
            <DeleteParameters>
