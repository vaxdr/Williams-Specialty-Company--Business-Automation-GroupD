...
&nbsp;
        ...
        <br />
        <br />
        <asp:GridView ID="grdUsers" runat="server" AutoGenerateColumns="False" DataKeyNames="UserID" DataSourceID="SqlDataSource1" Visible="False">
            <Columns>
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" DeleteCommand="DELETE FROM [Users] WHERE [UserID] = ?" InsertCommand="INSERT INTO [Users] ([UserID], [UserLogon], [UserPassword], [UserSecLevel]) VALUES (?, ?, ?, ?)" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT * FROM [Users]" UpdateCommand="UPDATE [Users] SET [UserLogon] = ?, [UserPassword] = ?, [UserSecLevel] = ? WHERE [UserID] = ?">
            <DeleteParameters>
