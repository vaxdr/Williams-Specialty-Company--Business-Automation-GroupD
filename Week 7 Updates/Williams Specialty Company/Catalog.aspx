...
&nbsp;<asp:Label ID="lblUpdateCatalogSuccess" runat="server"></asp:Label>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" DeleteCommand="DELETE FROM [Product] WHERE [ProdID] = ?" InsertCommand="INSERT INTO [Product] ([ProdID], [ProdName], [ProdDescription], [ProdImage], [JobType], [MediaType], [ListPrice]) VALUES (?, ?, ?, ?, ?, ?, ?)" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT * FROM [Product]" UpdateCommand="UPDATE [Product] SET [ProdName] = ?, [ProdDescription] = ?, [ProdImage] = ?, [JobType] = ?, [MediaType] = ?, [ListPrice] = ? WHERE [ProdID] = ?">
            <DeleteParameters>
