...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Label ID="Label5" runat="server" Text="Order Number:" Visible="False"></asp:Label>
&nbsp;<asp:TextBox ID="txtOrderID" runat="server" Width="32px" Visible="False"></asp:TextBox>
    
        <br />
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT [EFName], [ELName], [EmployeeID] FROM [Employee]"></asp:SqlDataSource>
        <br />
...
&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Daniel's Connection String %>" ProviderName="<%$ ConnectionStrings:Daniel's Connection String.ProviderName %>" SelectCommand="SELECT [ProdName], [ProdID] FROM [Product]"></asp:SqlDataSource>
        <br />
        <br />
