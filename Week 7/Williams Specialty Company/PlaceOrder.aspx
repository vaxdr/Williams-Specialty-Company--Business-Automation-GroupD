...
&nbsp;&nbsp;
        <asp:DropDownList ID="drpEmployeeID" runat="server" DataSourceID="SqlDataSource1" DataTextField="EFName" DataValueField="EmployeeID" OnSelectedIndexChanged="drpEmployeeID_SelectedIndexChanged" style="width: 88px">
        </asp:DropDownList>
...
&nbsp;
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ConnectionString5.ProviderName %>" SelectCommand="SELECT [EmployeeID], [EFName] FROM [Employee]"></asp:SqlDataSource>
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;
