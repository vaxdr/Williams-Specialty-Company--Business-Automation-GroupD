...
public partial class PlaceOrder : System.Web.UI.Page
{
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        int.Parse(txtOrderID.Text),int.Parse(txtQuantity.Text), int.Parse(drpProductID.SelectedValue), txtMessage.Text, Session["CustID"], int.Parse(drpEmployeeID.SelectedValue)))
            {
